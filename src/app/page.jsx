...
export default function Home() {
	return (
		<div className='w-full'>
			{/* 01. Hero Section */}
			<section className='min-h-[90vh] flex items-center justify-center overflow-hidden w-full relative pt-10 pb-20'>
				<div className='grid items-center grid-cols-1 gap-16 px-8 mx-auto max-w-7xl md:grid-cols-2'>
					{/* Left Content */}
					<motion.div
						initial={{ opacity: 0, x: -50 }}
						animate={{ opacity: 1, x: 0 }}
						transition={{ duration: 0.8, ease: 'easeOut' }}
						className='relative z-10 p-10 md:p-14 rounded-[2.5rem] bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)]'
					>
						...
						>
							...
							<h1
								className='text-[3.5rem] md:text-5xl lg:text-7xl font-extrabold text-white mb-6 tracking-tight leading-[1.1]'
							...
							<div className='flex flex-wrap items-center gap-5'>
								<Link
									href='/contact'
									className='group relative px-8 py-4 text-sm uppercase tracking-widest font-bold rounded-full bg-white text-gray-900 shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-105 hover:shadow-[0_0_40px_rgba(108,59,137,0.6)] transition-all duration-300'
								>
									Book an Audit
								</Link>
								<Link
									href='/projects'
									className='px-8 py-4 text-sm font-bold tracking-widest text-white uppercase transition-all border rounded-full bg-white/5 border-white/20 hover:bg-white/10 hover:border-white/40 backdrop-blur-md hover:scale-105'
								>
									Portfolio
								</Link>
							</div>
					...
					>
						<motion.div
							...
							className='relative w-full max-w-[320px] mx-auto md:ml-auto aspect-square'
						>
							<motion.div
								animate={{ rotate: 360 }}
							...
							<motion.div
								...
								className='absolute top-[10%] -left-[10%] p-4 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl flex items-center justify-center text-white'
							>
								<motion.div
									animate={{ rotate: 360 }}
									transition={{
							...
							<motion.div
								...
								className='absolute bottom-[10%] -right-[5%] p-4 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl flex items-center justify-center text-white'
							>
								<Bot
									size={32}
									className='filter drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]'
			...
			<div className='w-full bg-black/40 relative overflow-hidden py-32'>
			...
			<section className='max-w-5xl px-8 py-32 mx-auto text-center'>
				<motion.div
					initial={{ opacity: 0, scale: 0.95 }}
					whileInView={{ opacity: 1, scale: 1 }}
					viewport={{ once: true }}
					className='bg-gradient-to-br from-white/10 to-transparent p-12 md:p-24 rounded-[3rem] border border-white/20 shadow-[0_20px_60px_rgba(0,0,0,0.5)] backdrop-blur-2xl relative overflow-hidden'
				>
					...
					<p className='max-w-2xl mx-auto mb-12 text-lg font-light text-gray-300 md:text-xl leading-relaxed'>
						Start your journey toward zero-touch operations. Book your free
						blueprint audit today.
					</p>
					<Link
						href='/contact'
						className='inline-flex items-center gap-3 px-12 py-6 bg-white text-gray-900 font-extrabold rounded-full shadow-[0_0_30px_rgba(255,255,255,0.3)] hover:scale-105 transition-all uppercase tracking-widest text-sm'
					>
