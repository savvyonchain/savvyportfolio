...
export const metadata = {
	title: 'Savvy | Frontend Developer & Automation Architect',
		...
		<html lang='en' className={`${spaceGrotesk.variable} overflow-x-hidden`}>
			...
			>
				...
				<div className='fixed inset-0 -z-50 overflow-hidden bg-[#0A0612] pointer-events-none'>
					...
					<div
						className='absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] bg-[var(--color-secondary)] rounded-full mix-blend-screen blur-[150px] opacity-[0.20] animate-pulse'
