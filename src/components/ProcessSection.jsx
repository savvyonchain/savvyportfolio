...
export default function ProcessSection() {
	...
	return (
		<section className='max-w-7xl mx-auto px-8 py-20 relative'>
			...
			<div className='rounded-[3.5rem] bg-white/[0.03] backdrop-blur-3xl border border-white/10 overflow-hidden flex flex-col lg:flex-row shadow-[0_40px_100px_rgba(0,0,0,0.6)] relative group'>
				...
				<div className='lg:w-1/3 relative min-h-[400px] lg:min-h-full overflow-hidden bg-[#050308] border-r border-white/5'>
					...
					<div className='absolute inset-0 flex flex-col items-center justify-center p-12 text-center'>
						...
						<h2 className='text-4xl md:text-6xl font-black text-white leading-none tracking-tighter uppercase mb-2' style={{ fontFamily: 'var(--font-space)' }}>
				...
				{/* Right Side: Steps */}
				<div className='lg:w-2/3 p-12 lg:p-20 relative bg-gradient-to-br from-white/[0.02] to-transparent'>
							...
							>
								<div className='flex items-center gap-10'>
									<div className='relative flex items-center justify-center'>
										<span className='text-5xl font-black text-white/5 group-hover:text-[var(--color-brand)]/30 transition-colors duration-500 select-none' style={{ fontFamily: 'var(--font-space)' }}>
											{prc.step_number}
										</span>
									</div>
									<div className='grid grid-cols-1 md:grid-cols-5 gap-8 w-full items-center'>
										<h3 className='col-span-2 text-2xl font-black text-white tracking-tight leading-tight group-hover:text-[var(--color-brand-light)] transition-colors duration-500'>
											{prc.title}
										</h3>
										<p className='col-span-3 text-gray-400 font-light text-base leading-relaxed group-hover:text-gray-200 transition-colors duration-500'>
											{prc.description}
										</p>
									</div>
								</div>
					...
					<div className='mt-16 flex flex-col md:flex-row items-center justify-between border-t border-white/5 pt-12 gap-10'>
						...
						<button 
							...
							className='group relative px-12 py-5 bg-[var(--color-brand)] text-white font-black rounded-2xl hover:scale-105 transition-all shadow-[0_0_40px_rgba(108,59,137,0.4)] uppercase tracking-[0.2em] text-[10px]'
						>
