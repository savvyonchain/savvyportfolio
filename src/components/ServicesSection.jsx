				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
					{services.map((service, i) => (
						<motion.div
							...
							whileHover={{ y: -10 }}
							className='p-6 sm:p-8 md:p-12 rounded-[2rem] sm:rounded-[3rem] bg-white/[0.03] backdrop-blur-3xl border border-white/10 flex flex-col items-start shadow-2xl relative group overflow-hidden transition-all duration-500 hover:bg-white/[0.06] hover:border-[var(--color-brand)]/50 min-w-0'
						>
							...
							<div className='relative z-10 w-full flex-1'>
								<h3 className='text-2xl sm:text-3xl font-black text-white mb-6 leading-[1.1] tracking-tight group-hover:text-gradient transition-all duration-500 break-words'>
									{service.title}
								</h3>
